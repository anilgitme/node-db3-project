...
async function findSteps(scheme_id) { // EXERCISE C
    ...
    */
    const schemeSteps = await db('steps')
...
async function add(scheme) { // EXERCISE D
    ...
    */
    const newScheme = await db('schemes').insert(scheme); //insert added scheme in schemes
    return newScheme
}
...
async function addStep(scheme_id, step) { // EXERCISE E
    ...
    */
    const newStep = await db('steps')
        ...
        .then(([scheme_id]) => findSteps(scheme_id)) // using this callback should give me all the steps with the given id
    return newStep;
}
